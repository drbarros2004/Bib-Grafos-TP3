...
int main () {
    ...
    int max_flow = FordFulkerson_Vector(flow_network_1, 1, 2, true, txt_file_results_name);
    ...
    for (int i = 0; i < 10; i++) {
        tempo_total_ford_fulkerson += FordFulkerson_Vector_With_Execution_Time(flow_network_1, 1, 2);
    }
